...
class App extends Component {    
  ...
  componentDidMount() {
    // This is a MOCK API just for Demo Purposes!
    axios.get(`ttp://localhost:5000/map/locations`).then((res) => {
      list= res.data
      listLocation(list)
      console.log(list);
    });
  ...
  // });console.log(locations,"eeeeeeeeeeeeeeeeeeeeeeeeeeeeeee",list);
  render() {
  return (
